  ...
  <div class="hearder">
    ...
    <div class="nav-buttons">
      <router-link to="/Hearder">
        <button class="students-btn active">Students</button>
      </router-link>
      <router-link to="/HearderP">
        <button class="parents-btn">Parents</button>
      </router-link>
    </div>
  ...
  <div class="content">
    ...
    <div class="boxContent">
      <form action="https://request-absence-bot.onrender.com/sent" method="POST">
        ...
        <textarea name="currentlyaddress" placeholder="Enter your current address" required></textarea>
        ...
        <textarea name="description" placeholder="Enter your reason for absence" required></textarea>
